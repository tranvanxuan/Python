...
class Location_Tracker:
    ...
    def Track_location(self, event):
        # lay gia tri tu so dien thoai nhap vao qua phuong thuc get
        phone_number = self.phone_number.get()
        country = "Country is Unknown"  # tao bien contry
        if phone_number:  # neu phone_number khac rong
            # bien allpha_2 tra ve tien viet tat cua quoc gia
            # tracked tra ve chi tiet quoc gia
